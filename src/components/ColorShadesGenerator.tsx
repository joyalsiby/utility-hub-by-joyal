      ...
      <div className="bg-white shadow-sm border border-slate-200 rounded-xl p-6 sm:p-8 space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 items-end">
          ...
          <div className="space-y-2">
            <label className="text-xs font-medium text-slate-500 uppercase tracking-wide">Base Color</label>
            <div className="flex items-center gap-2">
              ...
              <input
                ...
                className="w-full px-3 py-2 text-sm border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 font-mono uppercase"
                placeholder="#3B82F6"
              />
            </div>
          </div>
          ...
          <div className="space-y-2 lg:col-span-2">
            <div className="flex justify-between">
              <label className="text-xs font-medium text-slate-500 uppercase tracking-wide">Darken/Lighten Step</label>
              <span className="text-xs font-mono text-slate-600 bg-slate-100 px-2 py-0.5 rounded">{step}%</span>
            </div>
            <input
              type="range"
              min="1"
          ...
          <div className="space-y-2">
            <div className="flex justify-between">
              <label className="text-xs font-medium text-slate-500 uppercase tracking-wide">Count</label>
              <span className="text-xs font-mono text-slate-600 bg-slate-100 px-2 py-0.5 rounded">{count}</span>
            </div>
            <input
              type="range"
              min="3"
        ...
        <div className="space-y-6">
          <div className="flex flex-col sm:flex-row h-auto sm:h-32 rounded-xl overflow-hidden shadow-sm border border-slate-200 divide-y sm:divide-y-0 sm:divide-x divide-slate-200/50">
          ...
          <div className="flex justify-center gap-4">
             <button
              ...
              className="flex items-center gap-2 px-6 py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-medium shadow-sm transition-all hover:shadow-md active:scale-95 text-sm"
            >
            ...
            <button
              ...
              className="flex items-center gap-2 px-6 py-2.5 bg-white border border-slate-200 hover:bg-slate-50 text-slate-700 rounded-lg font-medium shadow-sm transition-all hover:shadow-md active:scale-95 text-sm"
            >
              <Download size={18} />
              Download SVG
            </button>
        ...
        {selectedColor && (
          <div className="border-t border-slate-100 pt-8">
            <div className="flex flex-col md:flex-row gap-8 items-center md:items-start">
              <div 
                className="w-32 h-32 rounded-2xl shadow-sm border border-slate-200 flex-shrink-0"
                style={{ backgroundColor: selectedColor }}
              />
              <div className="flex-1 space-y-4 w-full">
                <h3 className="text-lg font-medium text-slate-900">Selected Color Details</h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="p-4 bg-slate-50 rounded-xl border border-slate-100 space-y-1">
                    <span className="text-xs text-slate-500 uppercase tracking-wide">HEX</span>
                    <div className="flex items-center justify-between">
                      <span className="font-mono text-slate-900 font-medium">{colord(selectedColor).toHex()}</span>
                      <button 
                  ...
                  <div className="p-4 bg-slate-50 rounded-xl border border-slate-100 space-y-1">
                    <span className="text-xs text-slate-500 uppercase tracking-wide">RGB</span>
                    <div className="flex items-center justify-between">
                      <span className="font-mono text-slate-900 font-medium">{colord(selectedColor).toRgbString()}</span>
                      <button 
                  ...
                  <div className="p-4 bg-slate-50 rounded-xl border border-slate-100 space-y-1">
                    <span className="text-xs text-slate-500 uppercase tracking-wide">HSL</span>
                    <div className="flex items-center justify-between">
                      <span className="font-mono text-slate-900 font-medium">{colord(selectedColor).toHslString()}</span>
                      <button 
                  ...
                  <div className="p-4 bg-slate-50 rounded-xl border border-slate-100 space-y-1">
                    ...
                    <div className="flex items-center justify-between">
                      <span className="font-mono text-slate-900 font-medium capitalize">{colord(selectedColor).toName({ closest: true }) || 'Unknown'}</span>
                    </div>
                  </div>
                </div>
              </div>
