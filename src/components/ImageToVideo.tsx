  ...
  return (
    <div className="w-full max-w-3xl space-y-8">
      ...
      <div className="bg-white shadow-sm border border-slate-200 rounded-xl p-6 sm:p-8 space-y-8">
        ...
        {!imagePreview ? (
          <div 
            className="border-2 border-dashed border-slate-200 rounded-xl p-12 flex flex-col items-center justify-center text-center hover:border-blue-400 hover:bg-blue-50/50 transition-all cursor-pointer group"
          ...
          <div className="space-y-6">
            {/* Preview Area */}
            <div className="relative rounded-xl overflow-hidden bg-slate-100 border border-slate-200 aspect-video flex items-center justify-center group">
              <img 
                src={imagePreview} 
                alt="Preview" 
              ...
              {!isConverting && !videoUrl && (
                <button 
                  ...
                  className="absolute top-4 right-4 p-2 bg-white/90 backdrop-blur-sm hover:bg-white text-slate-600 rounded-full shadow-sm opacity-0 group-hover:opacity-100 transition-all"
                >
                  <X size={20} />
                </button>
              )}
                ...
                <div className="flex flex-col items-center gap-4 w-full animate-in fade-in slide-in-from-bottom-4 duration-500">
                  ...
                  <div className="flex gap-3 w-full sm:w-auto">
                    <button
                      ...
                      className="flex-1 sm:flex-none flex items-center justify-center gap-2 px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-medium shadow-sm transition-all hover:shadow-md active:scale-95"
                    >
                      <Download size={20} />
                      Download .mp4
                    </button>
                    ...
                    <button
                      ...
                      className="flex-1 sm:flex-none px-6 py-3 bg-white border border-slate-200 hover:bg-slate-50 text-slate-700 rounded-lg font-medium transition-colors"
                    >
                      Convert Another
                    </button>
                  </div>
